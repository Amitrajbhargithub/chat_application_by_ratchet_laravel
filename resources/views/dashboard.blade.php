...
conn.onmessage = function(e){
			...
			for(var count = 0; count < data.data.length; count++)
			{
				...
				if(data.data[count].user_image != '')
				{
					if(data.data[count].user_image) {
						...
						user_image = `<img src="{{ asset('https://i.pinimg.com/originals/43/96/61/439661dcc0d410d476d6d421b1812540.jpg') }}" width="40" class="rounded-circle" />`
					}
				}
				else
				{
	...
	if(data.response_load_notification)
	{
		...
		for(var count = 0; count < data.data.length; count++)
		{
			...
			{
				user_image = `<img src="https://i.pinimg.com/originals/43/96/61/439661dcc0d410d476d6d421b1812540.jpg" width="40" class="rounded-circle" />`;
			}
			...
			for(var count = 0; count < data.data.length; count++)
			{
				...
				if(data.data[count].user_image != '')
				{
					if(data.data[count].user_image) {
						...
						user_image = `<img src="https://i.pinimg.com/originals/43/96/61/439661dcc0d410d476d6d421b1812540.jpg" width="35" class="rounded-circle" />`;
					}
				}
				else
				{
					user_image = `<img src="{{ asset('https://i.pinimg.com/originals/43/96/61/439661dcc0d410d476d6d421b1812540.jpg') }}" width="35" class="rounded-circle" />`;
				}
...
function make_chat_area(user_id, to_user_name)
{
	...
	<div class="input-group mb-3">
		<div id="message_area" class="form-control" contenteditable style="min-height:50px; border:1px solid #ccc; border-radius:5px;"></div>
